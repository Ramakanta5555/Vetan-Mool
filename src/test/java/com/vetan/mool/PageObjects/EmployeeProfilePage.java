...
public class EmployeeProfilePage {
	...
	@FindBy(xpath = "(//button[contains(@class,'button-lib button-type-13')])[3]")
	@CacheLookup
	...
	@FindBy(xpath = "(//span[normalize-space()='Edit Credentials'])[1]")
	@CacheLookup
	...
	@FindBy(xpath = "(//input[@value='CDSWQ1234S'])[1]")
	@CacheLookup
	WebElement txtECPan;
	...
	@FindBy(xpath = "(//input[@value='ksidh@yao.com'])[1]")
	@CacheLookup
	...
	public void settxtECEmail(String eCemail)
	{
	...
	@FindBy(xpath = "(//td[normalize-space()='ZlObpM AMJtM'])[1]")
	@CacheLookup
	WebElement btnView;
	...
	{
		txtPhoneNumber.sendKeys(Keys.CONTROL + "a", Keys.DELETE);
	}
